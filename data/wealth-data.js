...
const WEALTH_COUNTRY_DATA = {
    ...
    // ==================== Middle East ====================
    SA: {
        name: { en: 'Saudi Arabia', ko: '사우디아라비아' },
    ...
    AE: {
        name: { en: 'United Arab Emirates', ko: 'UAE' },
    ...
    CI: {
        name: { en: "Côte d'Ivoire", ko: '코트디부아르' },
    ...
    DO: {
        name: { en: 'Dominican Republic', ko: '도미니카공화국' },
    ...
    TT: {
        name: { en: 'Trinidad & Tobago', ko: '트리니다드토바고' },
